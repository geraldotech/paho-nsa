...
export default {
  en: {
    ...
    collabSubtitle: 'Activities carried out in the past three years.',
    collabSubtitleProgresReport: 'Activities carried out over the past year',
    ...
    nsaFocalRole: 'Focal point title',
    contactEmail: 'Contact email',
    pahoFocal: 'PAHO focal point',
    objectives: 'Objectives',
    workFields: 'Main areas of work',
    board: 'Governing body members and affiliations',
    bodies: 'UN & NGOs in Formal Relations with the NSA',
  ...
  es: {
    ...
    collabSubtitle: 'Actividades realizadas en los últimos tres años',
    collabSubtitleProgresReport: 'Actividades realizadas durante el último año',
    ...
    nsaFocalRole: 'Cargo del punto focal',
    contactEmail: 'Correo de contacto',
    pahoFocal: 'Punto focal OPS',
    objectives: 'Objetivos',
    workFields: 'Áreas de trabajo',
    board: 'Miembros del órgano de governanza y afiliaciones',
    bodies: 'Naciones Unidas y ONG en relaciones formales con el ANE',
